...
This module processes raw military data from Module 1 and performs:
• Data normalization (currency, units, numbers)
• Derived metrics calculation (Power Index Gap, Assets per Capita, etc.)
