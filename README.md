...
d:\Miletry\
├── data/
│   ├── urls.txt              # Input: 144 country URLs (one per line)
│   ├── raw_data.csv          # Module 1 Output: Scraped raw data
│   ├── clean_data.csv        # Module 2 Output: Cleaned/normalized data
│   └── kpi_data.csv          # Module 2 Output: Derived metrics/KPIs
│
├── scripts/
│   ├── scraper.py            # Module 1: Web scraping pipeline
...
|---------|------|---------|
| **v2.0** | Jan 2026 | Full platform: Scraper + Transformer + Dashboard |
